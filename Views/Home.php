...
<div id="mainBanner" class="carousel slide mb-4" data-bs-ride="carousel" data-bs-interval="3000">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="./asset/images/banner.jpg" class="d-block w-100 banner"
                style="height: 500px; width: 100%; object-fit: cover;">
        </div>
        <div class="carousel-item">
            <img src="./asset/images/banner1.jpg" class="d-block w-100 banner" alt="Banner 2"
                style="height: 500px; width: 100%; object-fit: cover;">
        </div>
        <div class="carousel-item">
            <img src="./asset/images/banner2.jpg" class="d-block w-100 banner" alt="Banner 3"
                style="height: 500px; width: 100%; object-fit: cover;">
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="category-container">
                ...
                <a href="index.php?route=category&category_id=<?= $category['category_id'] ?>" class="category-link">
            ...
            <div class="product-card" data-aos="fade-up" data-aos-delay="<?= $index * 100 ?>">
                ...
                <div class="product-image">
                    ...
                    <div class="product-overlay">
                        <a href="index.php?route=add_to_cart&id=<?= $product['product_id']; ?>" class="cart-btn">
                ...
                <div class="product-details">
                    <a style="text-decoration: none;color:black;hover{color:red}"
                        href="index.php?route=detail_product&id=<?= $product['product_id'] ?>">
            ...
            <div class="card h-100 shadow-sm">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="index.php?route=add_to_cart&id=<?= $product['product_id']; ?>"
                        class="btn btn-primary mt-auto" style="border-radius: 25px;">
                        <i class="fas fa-shopping-cart me-2"></i>Thêm vào giỏ
                    </a>
                    <?php 
                            else:
                        ?>
                    <a href="index.php?route=login" class="btn btn-primary mt-auto" style="border-radius: 25px;">
                        <i class="fas fa-shopping-cart me-2"></i>Thêm vào giỏ
                    </a>
                    <?php 
                            endif;
